...
IM_W,IM_H = (420,280)
time_step = 1.5
# image_base_dir = '/media/harrison/HD 2TB/carla'
# image_save_path ='data_safe'
image_save_path = '/media/harrison/HD 2TB/carla/data_safe'
seq_len = 15
...
class Carla_session:
    ...
    # For spawning traffic/other vehicles
    ...
    # For spawning the vehicle used for data collection
    def add_actors(self):
        # --------------
        # Spawn vehicles
        # --------------
        ...
        # SpawnActor(vehicle_bp, transform).then(SetAutopilot(FutureActor, True, traffic_manager.get_port()))
